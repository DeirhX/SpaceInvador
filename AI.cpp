...
void JimmyLeetAI::Advance(float delta, Renderable& invader)
{
	...
	// They say all things happen in cycles. Certainly they do for Jimmy with clever use of cyclic trigonometric functions
